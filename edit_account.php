      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <div class="panel-heading clearfix">
            ...
            <span><?php  echo text()->translate('Change My photo'); ?> </span>
          </div>
        </div>
            ...
            <div class="col-md-8">
              ...
              <div class="form-group">
                <input type="hidden" name="user_id" value="<?php echo $user['id'];?>">
                 <button type="submit" name="submit" class="btn btn-warning"><?php  echo text()->translate('Change'); ?> </button>
              </div>
             </form>
            </div>
          </div>
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
          <form method="post" action="edit_account.php?id=<?php echo (int)$user['id'];?>" class="clearfix">
            ...
            <div class="form-group">
                  <label for="username" class="control-label"><?php  echo text()->translate('Username'); ?></label>
                  <input type="text" class="form-control" name="username" value="<?php echo remove_junk(ucwords($user['username'])); ?>">
            </div>
            <div class="form-group clearfix">
                    <a href="change_password.php" title="change password" class="btn btn-danger pull-right"><?php  echo text()->translate('Change Password'); ?></a>
