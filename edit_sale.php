  ...
  <div class="panel">
    <div class="panel-heading clearfix">
      <strong>
        ...
        <span><?php  echo text()->translate('All Sales'); ?></span>
     </strong>
     <div class="pull-right">
       <a href="sales.php" class="btn btn-primary"><?php  echo text()->translate('Show all sales'); ?></a>
     </div>
    </div>
          ...
          <th> <?php  echo text()->translate('Action'); ?></th>
           ...
           <tbody  id="product_info">
              ...
              <form method="post" action="edit_sale.php?id=<?php echo (int)$sale['id']; ?>">
                ...
                <td>
                  <button type="submit" name="update_sale" class="btn btn-primary"><?php  echo text()->translate('Update sale'); ?></button>
                </td>
              </form>
              </tr>
           </tbody>
